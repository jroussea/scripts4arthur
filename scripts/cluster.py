...
#os.chdir("LAGOON/lagoon/results/")
...
edges_name = "/home/jrousseau/Documents/git_projects/scripts4arthur/results/diamond_ssn_80.0_80.0_1e-05.tsv"
nodes_name = "/home/jrousseau/Documents/git_projects/scripts4arthur/results/test"
condition_name = "plouf"


# importation des dataframe contenant 
# les informations concernant les noeuds
# les informations concernant les arrêtes
edges = pd.read_csv(edges_name, sep = "\t", header = None)
nodes = pd.read_csv(nodes_name, sep = "\t", header = None) 
