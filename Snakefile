    ...
    rule diamond_db:
        ...
        run:
            ...
            with open(str(log),"w") as l:
                ...
                command_client = ["diamond-aligner", "makedb", "--in", str(input), "--db",
                                  str(output)]
                command_cluster = ["diamond", "makedb", "--in", str(input), "--db", str(output)]
    ...
    rule diamond_blastp:
        ...
        run:
            ...
            with open(str(log),"w") as l:
                ...
                command_client = ["diamond-aligner", "blastp", "-d", str(input.db), "-q",
                ...
                command_cluster = ["diamond", "blastp", "-d", str(input.db), "-q", str(input.fasta),
